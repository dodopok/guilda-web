...
process.env.YCLOUD_API_BASE_URL = 'https://ycloud.example.test'
process.env.ESTEVAO_API_URL = 'https://estevao.example.test'
process.env.ESTEVAO_API_KEY = 'test-key'
process.env.SONG_SEARCH_URL = 'https://busca.example.test/cc'
process.env.SONG_KEY_PAGE_BASE = 'https://cifra.example.test'
